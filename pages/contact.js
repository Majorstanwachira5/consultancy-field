    ...
    <Layout>
      ...
      <section className="section-padding bg-gradient-to-r from-primary to-primary-dark text-white relative">
        <img
          src="/logo4.png"
          alt="DataProtect Co."
          className="absolute inset-0 w-full h-full object-contain opacity-3"
        />
        <div className="container text-center relative z-10">
          <h1 className="text-4xl font-bold mb-4">Get in Touch</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Ready to secure your data and achieve compliance? Let's discuss how
            we can help your organization succeed.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Speak directly with our experts for immediate guidance and
                support.
              </p>
              <p className="text-lg font-semibold text-primary mb-1">
                +254 759 689 685 (Kenya)
              </p>
              <p className="text-lg font-semibold text-primary mb-2">
                +44 (0) 20 7123 4567 (UK)
              </p>
              <p className="text-sm text-gray-500">
                Mon-Fri, 9:00 AM - 6:00 PM EAT/GMT
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-600 mb-4">
                Visit our London office for in-person consultations and
                meetings.
              </p>
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="privacy" className="text-sm text-gray-600">
                    ...
                    and consent to DataProtect Co. processing my personal data
            ...
            <div>
              ...
              <div className="card mt-8">
                ...
                <p className="text-gray-600 text-center mb-6">
                  Take our 2-minute assessment to identify your compliance gaps
                </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-red-900 mb-2">
                Data Breach Emergency Support
              </h3>
              <p className="text-red-800 mb-4">
                Experiencing a data breach? Our emergency response team is
                available 24/7 to provide immediate assistance.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="tel:+254759689685"
                ...
                <a
                  href="mailto:majorstan20@gmail.com"
          ...
          <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <p className="text-sm text-gray-600">
                We can typically begin within 1-2 weeks of initial consultation,
            ...
            <div className="card">
              ...
              <p className="text-sm text-gray-600">
                Yes, we serve organizations of all sizes with tailored solutions
            ...
            <div className="card">
              ...
              <p className="text-sm text-gray-600">
                Gap analysis, risk overview, and customized recommendations with
                no obligation.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-sm text-gray-600">
                Yes, we offer retainer agreements for ongoing compliance
